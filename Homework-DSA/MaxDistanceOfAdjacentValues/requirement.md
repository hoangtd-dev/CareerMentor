Max Distance of Adjacent Values — Task Description
...
that, given a non-empty array A consisting of N integers, returns the maximum distance between indices of this array that have adjacent values. The function should return −1 if no adjacent indices exist.
